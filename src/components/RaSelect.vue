...
const props = defineProps<TRaSelectProps>()

const selectedModel: ModelRef<TSelectionOption | undefined> = defineModel()
selectedModel.value = props.options[0]
</script>
    ...
    <div class="relative mt-2">
      ...
      >
        <span class="flex items-center">
          <span class="ml-3 block truncate">{{ selectedModel?.value }}</span>
        </span>
